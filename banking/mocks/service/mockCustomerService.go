...
func (m *MockCustomerService) GetAllCustomer(arg0 string) ([]dto.CustomerResponse, *customErrors.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockCustomerService) GetCustomer(arg0 string) (*dto.CustomerResponse, *customErrors.AppError) {
	m.ctrl.T.Helper()
