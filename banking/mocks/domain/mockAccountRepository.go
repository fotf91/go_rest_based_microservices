...
import (
	customErrors "banking/customErrors"
...
func (m *MockAccountRepository) FindBy(arg0 string) (*domain.Account, *customErrors.AppError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindBy", arg0)
	ret0, _ := ret[0].(*domain.Account)
	ret1, _ := ret[1].(*customErrors.AppError)
	return ret0, ret1
}
...
func (m *MockAccountRepository) Save(arg0 domain.Account) (*domain.Account, *customErrors.AppError) {
	m.ctrl.T.Helper()
...
func (m *MockAccountRepository) SaveTransaction(arg0 domain.Transaction) (*domain.Transaction, *customErrors.AppError) {
	m.ctrl.T.Helper()
