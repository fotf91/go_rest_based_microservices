...
type AccountService interface {
	...
	MakeTransaction(dto.TransactionRequest) (*dto.TransactionResponse, *customErrors.AppError)
}
...
func (s DefaultAccountService) MakeTransaction(req dto.TransactionRequest) (*dto.TransactionResponse, *customErrors.AppError) {
	...
	if req.IsTransactionTypeWithdrawal() {
		...
		if !account.CanWithdraw(req.Amount) {
			return nil, customErrors.NewValidationError("Insufficient balance in the account")
		}
	}
